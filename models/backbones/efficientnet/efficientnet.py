...
from models import FeatureHooks
from models import register_model
from models.constants import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD, IMAGENET_INCEPTION_MEAN, \
    IMAGENET_INCEPTION_STD
from models.layers import SelectAdaptivePool2d, create_conv2d, ConvBnAct
from models.utils import adapt_model_from_file, load_pretrained
...
url_weight_dir_1 = 'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/'
url_weight_dir_2 = 'https://imvl-automl-sh.oss-cn-shanghai.aliyuncs.com/darts/hyperml/hyperml/job_45403/'
default_cfgs = {
    'mnasnet_050': _cfg(),
    'mnasnet_075': _cfg(),
    'mnasnet_100': _cfg(url=url_weight_dir_1 + 'mnasnet_b1-74cb7081.pth'),
    'mnasnet_140': _cfg(),

    'semnasnet_050': _cfg(),
    'semnasnet_075': _cfg(),
    'semnasnet_100': _cfg(url=url_weight_dir_1 + 'mnasnet_a1-d9418771.pth'),
    'semnasnet_140': _cfg(),
    'mnasnet_small': _cfg(),

    'mobilenetv2_100': _cfg(url=url_weight_dir_1 + 'mobilenetv2_100_ra-b33bc2c4.pth'),
    'mobilenetv2_110d': _cfg(url=url_weight_dir_1 + 'mobilenetv2_110d_ra-77090ade.pth'),
    'mobilenetv2_120d': _cfg(url=url_weight_dir_1 + 'mobilenetv2_120d_ra-5987e2ed.pth'),
    'mobilenetv2_140': _cfg(url=url_weight_dir_1 + 'mobilenetv2_140_ra-21a4e913.pth'),

    'fbnetc_100': _cfg(url=url_weight_dir_1 + 'fbnetc_100-c345b898.pth', interpolation='bilinear'),
    'spnasnet_100': _cfg(url=url_weight_dir_1 + 'spnasnet_100-048bc3f4.pth', interpolation='bilinear'),

    'efficientnet_b0': _cfg(url=url_weight_dir_1 + 'efficientnet_b0_ra-3dd342df.pth'),
    'efficientnet_b1': _cfg(url=url_weight_dir_1 + 'efficientnet_b1-533bc792.pth',
                            input_size=(3, 240, 240), pool_size=(8, 8)),
    'efficientnet_b2': _cfg(url=url_weight_dir_1 + 'efficientnet_b2_ra-bcdf34b7.pth',
                            input_size=(3, 260, 260), pool_size=(9, 9)),
    'efficientnet_b2a': _cfg(url=url_weight_dir_1 + 'efficientnet_b2_ra-bcdf34b7.pth',
                             input_size=(3, 288, 288), pool_size=(9, 9), crop_pct=1.0),
    'efficientnet_b3': _cfg(url=url_weight_dir_1 + 'efficientnet_b3_ra-a5e2fbc7.pth',
                            input_size=(3, 300, 300), pool_size=(10, 10), crop_pct=0.904),
    'efficientnet_b3a': _cfg(url=url_weight_dir_1 + 'efficientnet_b3_ra-a5e2fbc7.pth',
    ...
    'efficientnet_es': _cfg(url=url_weight_dir_1 + 'efficientnet_es_ra-f111e99c.pth'),
    ...
    'efficientnet_b1_pruned': _cfg(
        url=url_weight_dir_2 + 'outputs/effnetb1_pruned_9ebb3fe6.pth',
        input_size=(3, 240, 240), pool_size=(8, 8), crop_pct=0.882, mean=IMAGENET_INCEPTION_MEAN,
        std=IMAGENET_INCEPTION_STD),
    'efficientnet_b2_pruned': _cfg(
        url=url_weight_dir_2 + '/outputs/effnetb2_pruned_203f55bc.pth',
        input_size=(3, 260, 260), pool_size=(9, 9), crop_pct=0.890, mean=IMAGENET_INCEPTION_MEAN,
        std=IMAGENET_INCEPTION_STD),
    'efficientnet_b3_pruned': _cfg(
        url=url_weight_dir_2 + '/outputs/effnetb3_pruned_5abcc29f.pth',
        input_size=(3, 300, 300), pool_size=(10, 10), crop_pct=0.904, mean=IMAGENET_INCEPTION_MEAN,
        std=IMAGENET_INCEPTION_STD),

    'tf_efficientnet_b0': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b0_aa-827b6e33.pth',
                               input_size=(3, 224, 224)),
    'tf_efficientnet_b1': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b1_aa-ea7a6ee0.pth',
                               input_size=(3, 240, 240), pool_size=(8, 8), crop_pct=0.882),
    'tf_efficientnet_b2': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b2_aa-60c94f97.pth',
                               input_size=(3, 260, 260), pool_size=(9, 9), crop_pct=0.890),
    'tf_efficientnet_b3': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b3_aa-84b4657e.pth',
                               input_size=(3, 300, 300), pool_size=(10, 10), crop_pct=0.904),
    'tf_efficientnet_b4': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b4_aa-818f208c.pth',
                               input_size=(3, 380, 380), pool_size=(12, 12), crop_pct=0.922),
    'tf_efficientnet_b5': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b5_ra-9a3e5369.pth',
                               input_size=(3, 456, 456), pool_size=(15, 15), crop_pct=0.934),
    'tf_efficientnet_b6': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b6_aa-80ba17e4.pth',
                               input_size=(3, 528, 528), pool_size=(17, 17), crop_pct=0.942),
    'tf_efficientnet_b7': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b7_ra-6c08e654.pth',
                               input_size=(3, 600, 600), pool_size=(19, 19), crop_pct=0.949),
    'tf_efficientnet_b8': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b8_ra-572d5dd9.pth',
                               input_size=(3, 672, 672), pool_size=(21, 21), crop_pct=0.954),

    'tf_efficientnet_b0_ap': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b0_ap-f262efe1.pth',
                                  mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD, input_size=(3, 224, 224)),
    'tf_efficientnet_b1_ap': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b1_ap-44ef0a3d.pth',
                                  mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD,
                                  input_size=(3, 240, 240), pool_size=(8, 8), crop_pct=0.882),
    'tf_efficientnet_b2_ap': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b2_ap-2f8e7636.pth',
                                  mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD,
                                  input_size=(3, 260, 260), pool_size=(9, 9), crop_pct=0.890),
    'tf_efficientnet_b3_ap': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b3_ap-aad25bdd.pth',
                                  mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD,
                                  input_size=(3, 300, 300), pool_size=(10, 10), crop_pct=0.904),
    'tf_efficientnet_b4_ap': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b4_ap-dedb23e6.pth',
                                  mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD,
                                  input_size=(3, 380, 380), pool_size=(12, 12), crop_pct=0.922),
    'tf_efficientnet_b5_ap': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b5_ap-9e82fae8.pth',
                                  mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD,
                                  input_size=(3, 456, 456), pool_size=(15, 15), crop_pct=0.934),
    'tf_efficientnet_b6_ap': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b6_ap-4ffb161f.pth',
                                  mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD,
                                  input_size=(3, 528, 528), pool_size=(17, 17), crop_pct=0.942),
    'tf_efficientnet_b7_ap': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b7_ap-ddb28fec.pth',
                                  mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD,
                                  input_size=(3, 600, 600), pool_size=(19, 19), crop_pct=0.949),
    'tf_efficientnet_b8_ap': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b8_ap-00e169fa.pth',
                                  mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD,
                                  input_size=(3, 672, 672), pool_size=(21, 21), crop_pct=0.954),

    'tf_efficientnet_b0_ns': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b0_ns-c0e6a31c.pth',
                                  input_size=(3, 224, 224)),
    'tf_efficientnet_b1_ns': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b1_ns-99dd0c41.pth',
                                  input_size=(3, 240, 240), pool_size=(8, 8), crop_pct=0.882),
    'tf_efficientnet_b2_ns': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b2_ns-00306e48.pth',
                                  input_size=(3, 260, 260), pool_size=(9, 9), crop_pct=0.890),
    'tf_efficientnet_b3_ns': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b3_ns-9d44bf68.pth',
                                  input_size=(3, 300, 300), pool_size=(10, 10), crop_pct=0.904),
    'tf_efficientnet_b4_ns': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b4_ns-d6313a46.pth',
                                  input_size=(3, 380, 380), pool_size=(12, 12), crop_pct=0.922),
    'tf_efficientnet_b5_ns': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b5_ns-6f26d0cf.pth',
                                  input_size=(3, 456, 456), pool_size=(15, 15), crop_pct=0.934),
    'tf_efficientnet_b6_ns': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b6_ns-51548356.pth',
                                  input_size=(3, 528, 528), pool_size=(17, 17), crop_pct=0.942),
    'tf_efficientnet_b7_ns': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_b7_ns-1dbc32de.pth',
                                  input_size=(3, 600, 600), pool_size=(19, 19), crop_pct=0.949),
    'tf_efficientnet_l2_ns_475': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_l2_ns_475-bebbd00a.pth',
                                      input_size=(3, 475, 475), pool_size=(15, 15), crop_pct=0.936),
    'tf_efficientnet_l2_ns': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_l2_ns-df73bb44.pth',
                                  input_size=(3, 800, 800), pool_size=(25, 25), crop_pct=0.96),

    'tf_efficientnet_es': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_es-ca1afbfe.pth',
                               mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5),
                               input_size=(3, 224, 224), ),
    'tf_efficientnet_em': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_em-e78cfe58.pth',
                               mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5),
                               input_size=(3, 240, 240), pool_size=(8, 8), crop_pct=0.882),
    'tf_efficientnet_el': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_el-5143854e.pth',
                               mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5),
                               input_size=(3, 300, 300), pool_size=(10, 10), crop_pct=0.904),

    'tf_efficientnet_cc_b0_4e': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_cc_b0_4e-4362b6b2.pth',
                                     mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD),
    'tf_efficientnet_cc_b0_8e': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_cc_b0_8e-66184a25.pth',
                                     mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD),
    'tf_efficientnet_cc_b1_8e': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_cc_b1_8e-f7c79ae1.pth',
                                     mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD,
                                     input_size=(3, 240, 240), pool_size=(8, 8), crop_pct=0.882),

    'tf_efficientnet_lite0': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_lite0-0aa007d2.pth',
                                  mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5),
                                  interpolation='bicubic',
                                  # should be bilinear but bicubic better match for TF bilinear at low res
                                  ),
    'tf_efficientnet_lite1': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_lite1-bde8b488.pth',
                                  mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5),
                                  input_size=(3, 240, 240), pool_size=(8, 8), crop_pct=0.882,
                                  interpolation='bicubic',
                                  # should be bilinear but bicubic better match for TF bilinear at low res
                                  ),
    'tf_efficientnet_lite2': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_lite2-dcccb7df.pth',
                                  mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5),
                                  input_size=(3, 260, 260), pool_size=(9, 9), crop_pct=0.890,
                                  interpolation='bicubic',
                                  # should be bilinear but bicubic better match for TF bilinear at low res
                                  ),
    'tf_efficientnet_lite3': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_lite3-b733e338.pth',
                                  mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5),
                                  input_size=(3, 300, 300), pool_size=(10, 10), crop_pct=0.904,
                                  interpolation='bilinear'),
    'tf_efficientnet_lite4': _cfg(url=url_weight_dir_1 + 'tf_efficientnet_lite4-741542c3.pth',
                                  mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5),
                                  input_size=(3, 380, 380), pool_size=(12, 12), crop_pct=0.920,
                                  interpolation='bilinear'),

    'mixnet_s': _cfg(url=url_weight_dir_1 + 'mixnet_s-a907afbc.pth'),
    'mixnet_m': _cfg(url=url_weight_dir_1 + 'mixnet_m-4647fc68.pth'),
    'mixnet_l': _cfg(url=url_weight_dir_1 + 'mixnet_l-5a9a2ed8.pth'),
    'mixnet_xl': _cfg(url=url_weight_dir_1 + 'mixnet_xl_ra-aac3c00c.pth'),
    'mixnet_xxl': _cfg(),

    'tf_mixnet_s': _cfg(url=url_weight_dir_1 + 'tf_mixnet_s-89d3354b.pth'),
    'tf_mixnet_m': _cfg(url=url_weight_dir_1 + 'tf_mixnet_m-0f4d8805.pth'),
    'tf_mixnet_l': _cfg(url=url_weight_dir_1 + 'tf_mixnet_l-6c92e0c8.pth'),
}
...
class EfficientNet(BackboneBase):
    ...
    def __init__(self, block_args, num_classes=1000, num_features=1280, in_chans=3, stem_size=32,
        ...
        builder = EfficientNetBuilder(
            ...
            norm_layer, norm_kwargs, drop_path_rate, feature_location='bottleneck', verbose=_DEBUG)
        self.blocks = nn.Sequential(*builder(self._in_chs, block_args))
        self._feature_info = builder.features
        self._in_chs = builder.in_chs
        self.encoder_channels = self.feature_channels()
        self.stage_names = [f'blocks.{self._feature_info[i]["stage_idx"]}' for i in self.out_indices]
        ...
        hooks = [dict(name=name, type='forward') for name in self.stage_names]
    ...
    def init_weights(module):
        efficientnet_init_weights(module)
