...
from models import register_model, FeatureHooks
from models.constants import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
from models.layers import SelectAdaptivePool2d
...
class HighResolutionNet(BackboneBase):
    ...
    def _make_neck(self, pre_stage_channels):
